...
public class Main {
	...
	public static void main(String[] args) throws SQLException, IOException, ParseException {
		...
		for (int i = slotGames.size() - 200; i < slotGames.size(); i++) {
			System.out.println();
		...
		// tested --> good function
		List<SlotGameRanking> slotGamRankLi = DataProcess.getSlotGameRankLi(slotGames);
		for (int i = slotGamRankLi.size() - 100; i < slotGamRankLi.size(); i++) {
			System.out.println();
		...
		// testing sorting list by gained money System.out.println("after sorting");
		...
		*/
		...
		for (int i = dividedLi.size() - 100; i < dividedLi.size(); i++) {
			System.out.println();
